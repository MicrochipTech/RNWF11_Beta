...
- [Using AT commands to connect to Azure.docx](https://github.com/MicrochipTech/RNWF11_Beta/blob/main/Using%20AT%20commands%20to%20connect%20to%20Azure.docx) - Document describing the AT commands to be used to connect to Azure Cloud.
...
- [RNWF11 Python script.py](https://github.com/MicrochipTech/RNWF11_Beta/blob/main/RNWF11_ClientCert.py) - Python script to read Serial Number and Device certificate from the device.
